...
export function renderMacros(macros) {
    return <>
        ...
        <span>{`Szénhidrát: ${formatNumber(macros.fastCarbohydrate + macros.slowCarbohydrate)} g (gyors: ${formatNumber(macros.fastCarbohydrate)} g - lassú: ${formatNumber(macros.slowCarbohydrate)} g - rost: ${formatNumber(macros.fiber)} g)`}</span>
